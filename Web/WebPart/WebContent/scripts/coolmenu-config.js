...
oCMenu.barwidth="100%"//"850" //The width of the background bar. Set this to "menu" if you want it to be the same width as the menu. (this will change to match the border if you have one) - Value: px || "%" || "menu"
...
oCMenu.level[2].width=200//oCMenu.level[0].width
...
// menu arrows
cmTopMenuImage='&nbsp;&nbsp;&nbsp;<img src="imagens/Darrow.gif">'
cmSubMenuImage='&nbsp;&nbsp;&nbsp;<img src="imagens/Rarrow.gif">'
