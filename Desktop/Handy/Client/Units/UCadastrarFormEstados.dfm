inherited FCadastrarFormEstados: TFCadastrarFormEstados
  Left = 367
  Top = 283
  ...
  object edAliqICMSIntra: TRzNumericEdit
    Left = 312
    Top = 48
    Width = 105
    Height = 21
  ...
  object edCodigoIBGE: TRzNumericEdit
    Left = 88
    Top = 48
    Width = 105
    Height = 21
  ...
  object cdsEstadoIva: TClientDataSet
    ...
    AfterCancel = cdsEstadoIvaAfterPost
    Left = 180
    Top = 232
    ...
    object cdsEstadoIvacodigo_nbm: TStringField
      FieldName = 'codigo_nbm'
      OnValidate = cdsEstadoIvacodigo_nbmValidate
      Size = 10
    end
  end
